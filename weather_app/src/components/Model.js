...
import { ModuleWrapperStyled } from './Components';
 ...
 // console.log(context)
  let mode=context.bkMode
    ...
    const addCity=(city)=>{
       ...
       setCities(filterCities)
       context.setSelectedCities([...context.selectedCities,city])
       toast.success(`${city.name} is selected`)
    }
  ...
  return (
    <ModuleWrapperStyled mode={mode}>
    <div className='model-wrapper'>
     <div className="bgClicker" onClick={handleOutClick}></div>
        <div className="model-content" onClick={(e)=>{e.preventDefault()}}> 
       <header/>
